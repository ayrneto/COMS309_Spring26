...
public class CounterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            String spotStr = extras.getString("SPOT", "1"); // default 1
            counter = Integer.parseInt(spotStr);
        } else {
            counter = 1;
        }
        numberTxt.setText(String.format("%02d", counter));
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("SPOT", String.valueOf(counter));  // key-value to pass to the MainActivity
