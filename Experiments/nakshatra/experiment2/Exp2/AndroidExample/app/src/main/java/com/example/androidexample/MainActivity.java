...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras == null) {
            messageText.setText("EffiPark Spot Allocation");
        } else {
            String number = extras.getString("SPOT");  // this will come from LoginActivity
            int spotNum = Integer.parseInt(number);
            messageText.setText("Assigned Spot: A-" + String.format("%02d", spotNum));
        }
