...
public class JsonObjReqActivity extends AppCompatActivity {
    ...
    private static final String URL_JSON_OBJECT = "http://10.0.2.2:3012/students";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < response.getJSONArray("students").length(); i++) {
                                studentsList.append("- ")
                                        .append(response.getJSONArray("students").getString(i))
                                        .append("\n");
                            }
                            ...
                            msgResponse.setText(formatted);

                        } catch (Exception e) {
                            msgResponse.setText("Parsing error.");
                        }
                    }
                },
