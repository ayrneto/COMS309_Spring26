...
//    }
    ...
    @PutMapping("/Persons/{PersonID}/laptops")
    String unassignlaptop(@PathVariable int PersonID){
        Person person = PersonRepository.findById(PersonID);
    ...
    @GetMapping("/Persons/{PersonID}/laptops")
    Laptop getLaptopbyPerson(@PathVariable int PersonID){
        Person person = PersonRepository.findById(PersonID);

        if(person == null)
            throw new RuntimeException("Person not found");

        return person.getLaptop();
    }
